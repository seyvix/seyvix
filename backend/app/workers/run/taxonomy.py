...
async def run_taxonomy_worker() -> None:
    ...
    @worker_rabbit.broker.subscriber(
        worker_rabbit.topology.taxonomy_queue,
    ...
    async with asyncio.TaskGroup() as task_group:
        task_group.create_task(
            poll_worker_forever(
                ...
                TaxonomyWorker,
                limit=runtime.settings.taxonomy_worker_batch_size,
                idle_sleep_seconds=runtime.settings.taxonomy_worker_poll_interval_seconds,
            )
        )
