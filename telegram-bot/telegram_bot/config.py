...
AUTO_GROUP_WINDOW_SECONDS = 3
MANUAL_COLLECTION_REMINDER_SECONDS = 1800
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        telegram_bot_database_url=_database_url(),
...
def _database_url() -> str:
    explicit = os.getenv("TELEGRAM_BOT_DATABASE_URL") or os.getenv("DATABASE_URL")
    if explicit:
        return explicit
